describe("INTERCEPT", () => {
  it("network request spy", function() {
    ...
    cy.intercept(
      "https://server-stage.pasv.us/course/coursesProgress/65c2da8504369c018a35764e", {fixture:"progress.json"}
    ).as("course");
    ...
    cy.wait("@login").then((wholeResponse) => {//pause until its done
    ...
    cy.visit('https://stage.pasv.us/profile/65c2da8504369c018a35764e/progress')
